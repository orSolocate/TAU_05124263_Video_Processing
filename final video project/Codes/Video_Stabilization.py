...
SMOOTHING_RADIUS = 150 #was 50 #mine 75

# Read input video
cap = cv2.VideoCapture('INPUT.avi')#was INPUT.avi
...
# Set up output video
out = cv2.VideoWriter('stabilize.avi', fourcc, fps, (w, h))
...
for i in range(n_frames - 2):
    ...
    prev_pts = cv2.goodFeaturesToTrack(prev_gray,
                                       maxCorners=1000,  # was 200 #mine 1000
    ...
    curr_pts, status, err = cv2.calcOpticalFlowPyrLK(prev_gray, curr_gray, prev_pts, None,winSize=(50,50),maxLevel=10)
